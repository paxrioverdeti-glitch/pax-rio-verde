...
export default function Home() {
  ...
  if (step === "success") return <main className="campaign-shell centered"><div className="success-panel"><div className="success-icon"><Check /></div><span className="eyebrow">ACEITE REGISTRADO</span><h1>Pronto, {name.split(" ")[0]}.</h1><p>Seu desconto de 5% será aplicado mensalmente quando o pagamento for feito pelo app.</p><p className="discount-notice">Importante: o desconto é válido somente para pagamentos realizados antes da data de vencimento da mensalidade.</p><div className="app-install-panel"><div className="install-copy"><span className="eyebrow">INSTALE O APP</span><p>Baixe o Pax Rio Verde no seu celular para acompanhar o seu benefício e facilitar o pagamento.</p></div><div className="store-row"><a className="store-badge apple" href="https://bit.ly/4wHo2SU" target="_blank" rel="noreferrer"><div className="badge-icon"><Image src="/logo-apple.png" alt="" width={22} height={22} /></div><span><small>Baixe na</small><b>App Store</b></span></a><a className="store-badge google" href="https://bit.ly/4zAPvs4" target="_blank" rel="noreferrer"><div className="badge-icon"><Image src="/play-store.png" alt="" width={22} height={22} /></div><span><small>Disponível no</small><b>Google Play</b></span></a></div></div><Logo /></div></main>;
